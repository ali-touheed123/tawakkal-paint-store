    ...
    useEffect(() => {
        const fetchProduct = async () => {
            ...
            if (productData) {
                ...
                const isBergerEleganceMattEmulsion = productData.brand === 'Berger' && productData.name?.toLowerCase().includes('elegance matt emulsion');
                ...
                else if (isBergerEleganceMattEmulsion) defaultShades = BERGER_ELEGANCE_MATT_EMULSION_SHADES;
