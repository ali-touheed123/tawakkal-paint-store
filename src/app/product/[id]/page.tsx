...
export default function ProductDetailPage() {
    ...
    const shadeCardPdf = useMemo(() => {
        ...
        if (brand === 'Berger' && name.toLowerCase().includes('weather coat glow 365')) return '/pdfs/berger_Weather_coat_Glow_365.pdf';
        if (brand === 'Berger' && name.toLowerCase().includes('vip weather coat')) return '/pdfs/berger_vip_Weather_coat.pdf';
        if (brand === 'Berger' && name.toLowerCase().includes('allrounder matt enamel')) return '/pdfs/berger_allrounder_matt_enamel.pdf';
